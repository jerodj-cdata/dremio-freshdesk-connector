...
@SourceType(value = "FreshDeskARP", label = "FreshDesk",uiConfig = "freshdesk-layout.json")
public class FreshDeskConf extends AbstractArpConf<FreshDeskConf> {
  private static final String ARP_FILENAME = "arp/implementation/freshdesk-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.freshdesk.FreshDeskDriver";
